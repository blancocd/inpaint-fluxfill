...
#SBATCH --output=/mnt/lustre/work/ponsmoll/pba534/inpaint/%j.out       # File to which STDOUT will be written - make sure this is not on $HOME
#SBATCH --error=/mnt/lustre/work/ponsmoll/pba534/inpaint/%j.err        # File to which STDERR will be written - make sure this is not on $HOME
...
# python /mnt/lustre/work/ponsmoll/pba534/inpaint/test_StableDiffusionControlNetInpaintPipeline.py
# python /mnt/lustre/work/ponsmoll/pba534/inpaint/test_inpaint.py
python /mnt/lustre/work/ponsmoll/pba534/inpaint/test_SDCNIP_4views.py
