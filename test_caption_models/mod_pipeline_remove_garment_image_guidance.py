import torch
from pipeline_flux_fill_two_masks_image_guid import FluxFillPipeline
...
for ring_image_guidance_weight in np.linspace(0.0, 1.0, 5):
    ...
    for scan in scans:
        ...
        gen_image = pipe(
            ...
            width=image.width,
            guidance_scale=30,
            mask_interpolation_param=1.0,
            use_ring_image_guidance=True,
            ring_image_guidance_weight=ring_image_guidance_weight,
